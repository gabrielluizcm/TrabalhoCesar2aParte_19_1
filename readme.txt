...
====================================================================================================================
    ...
    Os arquivos são os seguintes:
        ...
        app_prof.mem      		-> Arquivo com uma aplicação que utiliza todas as funções de seu kernel
        ...
        kernel_ref.ced			-> Arquivo sobre o qual você deve desenvolver a sua solução de kernel
...
====================================================================================================================
    ...
    Procedimento
        1) Carregue, normalmente, no simulador, o seu arquivo de kernel.
        2) Carregue, usando "carga parcial", no simulador, o programa de aplicação ".mem", fornecido pelo professor.
